                ...
                <CardContent>
                  <div className="space-y-3">
                    {popularArticles.map((item, index) => (
                      ...
                      >
                        <div className="flex-shrink-0 w-8 h-8 rounded-full bg-foreground/10 flex items-center justify-center text-sm font-bold text-foreground">
                          {index + 1}
                        </div>
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium group-hover:text-foreground/70 transition-colors line-clamp-2">
                            {item.title}
                          </p>
                  ...
                  <div className="space-y-2">
                    {['Alapok', 'Mérés', 'Kultúra', 'Jövő'].map((cat) => (
                      <button
                        ...
                        className="w-full text-left px-3 py-2 rounded-sm bg-foreground/10 hover:bg-foreground/15 transition-colors text-sm flex items-center justify-between group"
                      >
                        <span>{cat}</span>
