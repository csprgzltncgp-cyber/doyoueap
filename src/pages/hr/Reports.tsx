            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Progress value={parseFloat(satisfactionScore) * 20} style={{ '--progress-background': 'hsl(var(--chart-1))' } as React.CSSProperties} />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Progress value={parseFloat(npsScore) * 10} style={{ '--progress-background': 'hsl(var(--chart-1))' } as React.CSSProperties} />
                ...
                <div className="space-y-2">
                  ...
                  <Progress value={parseFloat(problemSolvingScore) * 20} style={{ '--progress-background': 'hsl(var(--chart-1))' } as React.CSSProperties} />
                ...
                <div className="space-y-2">
                  ...
                  <Progress value={parseFloat(performanceScore) * 20} style={{ '--progress-background': 'hsl(var(--chart-1))' } as React.CSSProperties} />
                ...
                <div className="space-y-2">
                  ...
                  <Progress value={parseFloat(wellbeingScore) * 20} style={{ '--progress-background': 'hsl(var(--chart-1))' } as React.CSSProperties} />
                ...
                <div className="space-y-2">
                  ...
                  <Progress value={parseFloat(consistencyScore) * 20} style={{ '--progress-background': 'hsl(var(--chart-1))' } as React.CSSProperties} />
