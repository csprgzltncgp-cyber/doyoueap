            ...
            <Card id="satisfaction-metrics-card">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Progress value={parseFloat(satisfactionScore) * 20} style={{ '--progress-background': 'linear-gradient(90deg, #3572ef 0%, #7a8ff5 100%)' } as React.CSSProperties} className="h-3" />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Progress value={parseFloat(npsScore) * 10} style={{ '--progress-background': 'linear-gradient(90deg, #3572ef 0%, #7a8ff5 100%)' } as React.CSSProperties} className="h-3" />
                ...
                <div className="space-y-2">
                  ...
                  <Progress value={parseFloat(problemSolvingScore) * 20} style={{ '--progress-background': 'linear-gradient(90deg, #3572ef 0%, #7a8ff5 100%)' } as React.CSSProperties} className="h-3" />
                ...
                <div className="space-y-2">
                  ...
                  <Progress value={parseFloat(performanceScore) * 20} style={{ '--progress-background': 'linear-gradient(90deg, #3572ef 0%, #7a8ff5 100%)' } as React.CSSProperties} className="h-3" />
                ...
                <div className="space-y-2">
                  ...
                  <Progress value={parseFloat(wellbeingScore) * 20} style={{ '--progress-background': 'linear-gradient(90deg, #3572ef 0%, #7a8ff5 100%)' } as React.CSSProperties} className="h-3" />
                ...
                <div className="space-y-2">
                  ...
                  <Progress value={parseFloat(consistencyScore) * 20} style={{ '--progress-background': 'linear-gradient(90deg, #3572ef 0%, #7a8ff5 100%)' } as React.CSSProperties} className="h-3" />
