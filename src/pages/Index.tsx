            ...
            <div className="max-w-7xl mx-auto px-4 py-2">
              ...
              <nav className="hidden md:flex gap-6 justify-center">
                ...
                <div className="relative group">
                  <button
                    onClick={() => {
                      if (openSubmenu === 'statistics') {
                        setOpenSubmenu(null);
                      } else {
                        setOpenSubmenu('statistics');
                      }
                    }}
                    className={`text-sm transition-colors flex items-center gap-2 pb-2 ${
                  ...
                  {openSubmenu === 'statistics' && (
                    <div className="absolute top-full left-0 mt-2 bg-white rounded-md shadow-lg py-2 min-w-[220px] z-50">
                      ...
                      <button
                        ...
                        className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-100 ${
                          section === 'health-map' ? 'bg-gray-100 font-medium' : ''
                        }`}
                      >
                        Egészség Térkép
                      </button>
                      <button
                        ...
                        className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-100 ${
                          section === 'satisfaction' ? 'bg-gray-100 font-medium' : ''
                        }`}
                      >
                        Elégedettségi Index
                      </button>
                      <button
                        ...
                        className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-100 ${
                          section === 'program-usage' ? 'bg-gray-100 font-medium' : ''
                        }`}
                      >
                        Program Használat
                      </button>
                  ...
                  {openSubmenu === 'events' && (
                    <div className="absolute top-full left-0 mt-2 bg-white rounded-md shadow-lg py-2 min-w-[200px] z-50">
                      <button
                        ...
                        className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-100 ${
                          section === 'workshops' ? 'bg-gray-100 font-medium' : ''
                        }`}
                      >
                        Workshopok
                      </button>
                      ...
                      <button
                        ...
                        className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-100 ${
                          section === 'lottery' ? 'bg-gray-100 font-medium' : ''
                        }`}
                      >
                        Nyereményjáték
                      </button>
