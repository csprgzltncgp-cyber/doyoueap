  ...
  return (
    <div className="space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>
          Az alább látható szöveg már tartalmazza a megadott program nevet ({programName || 'DoYouEAP'}) és cég nevet ({companyName}).
        </AlertDescription>
      </Alert>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            A szöveg szabadon szerkeszthető. A program és cég nevét már behelyettesítettük.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-2">
            ...
            <Textarea
              ...
              rows={accessMode === 'tokenes' ? 16 : accessMode === 'qr_code' ? 12 : 14}
